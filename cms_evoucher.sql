...
DROP TABLE IF EXISTS `buy_voucher`;
CREATE TABLE IF NOT EXISTS `buy_voucher` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `promo_code` varchar(11) NOT NULL UNIQUE,
  `voucher_id` varchar(50) NOT NULL,
  `pay_method_id` varchar(50) NOT NULL,
